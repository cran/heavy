heavyPS <-
function(x, y, family = Student(df = 4), nseg = 20, deg = 3, ord = 2, lambda = 1, method = "gcv", ngrid = 200, control = heavy.control())
{
  ...
  bbase <-
  function(x, xmin = min(x), xmax = max(x), nseg = 20, deg = 3) {
